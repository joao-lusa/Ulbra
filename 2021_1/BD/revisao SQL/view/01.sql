...
create view Valor_total_produtos_orçados_período
as
...
create view computador_estoque_positivo
as
...
select produtos.id, produtos.nome as nome_produtos
	from produtos inner join orcamentos_itens on produtos.id = orcamentos_itens.id_produto 
	inner join orcamentos on orcamentos.id = orcamentos_itens.id_orcamento
...
select * from orcamentos_itens;
       ...
       select  sum(orcamentos_itens.valor_unitario) as total,
    produtos.id, produtos.nome as nome_produtos, orcamentos.id as id_orcamentos, 
